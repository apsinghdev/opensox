...
export const newsletters: Newsletter[] = [
  ...
  },
  {
    ...
    takeaways: [
      "official launch of opensox.ai platform",
      "powerful ai capabilities for professionals",
  ...
  },
  {
    ...
    takeaways: [
      "thank you to all beta testers for valuable feedback",
      "thousands of suggestions implemented",
      "features built based on user needs",
      "stronger platform thanks to community input"
    ]
  }
];
